...
<ol>
<li>Either use the base image (pferrot/ochostats:1.0.7_20160329123700CEST_0.5.1) as is and e.g. customize dashboards from grafana UI once the container is up and running.</li>
